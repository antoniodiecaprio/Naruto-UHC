...
public class Orochimaru extends NarutoRole {
    ...
    public void onDistribute(Player player) {
        ...
        //TODO CHECK CAMP
        UHC.getUHC().getGameManager().getPlayers().stream().filter(e -> Bukkit.getPlayer(e) != null).map(e -> Bukkit.getPlayer(e).getName()).forEach(orochimaru::add);

        List<String> taka = new ArrayList<>();
        //TODO CHECK CAMP
        UHC.getUHC().getGameManager().getPlayers().stream().filter(e -> Bukkit.getPlayer(e) != null).map(e -> Bukkit.getPlayer(e).getName()).forEach(taka::add);
    ...
    public void onPlayerInventoryClick(InventoryClickEvent event, Player player) {
        if(event.getInventory().getName().equals("Edo Tensei")) {
            ...
            //TODO REVIVE PLAYER
            //TODO CHANGER LE CAMP DU JOUEUR
